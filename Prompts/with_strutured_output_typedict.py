...
class Review(TypedDict):
    key_themes: Annotated[list[str], 'The main themes discussed in the review (e.g., performance, camera, battery)']
    summary: Annotated[str, 'A brief summary of the review']
    sentiment: Annotated[str, 'The overall sentiment of the review (positive, negative, or neutral)']
    pro :Annotated[Optional[list[str]], 'A list of positive aspects mentioned in the review']
    con :Annotated[Optional[list[str]], 'A list of negative aspects mentioned in the review']
